...
export default function COOStrategicTasksPage() {
    ...
    return (
        <>
            <Header title="Strategic Tasks (COO)" />
            <main className="p-4 md:ml-64 md:p-8 space-y-8 pb-20 animate-in fade-in duration-500">
                ...
                {/* Assigned To Lead List - Filtered by current user internal logic */}
                <StrategicTasksList />
            </main>
        </>
    );
